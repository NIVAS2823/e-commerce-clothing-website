  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
      ...
      <div className={`absolute top-0 right-0 bottom-0 bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}>
        ...
        <NavLink onClick={() => setVisible(false)} className='py-0 pl-2 border' to='/'>HOME</NavLink>
        <NavLink onClick={() => setVisible(false)} className='py-2 pl-2 border' to='/collection'>COLLECTIONS</NavLink>
